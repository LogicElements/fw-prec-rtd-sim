...
start /b /wait ST-LINK_CLI.exe -c SWD -P RtdEmulator-BTL-20200529-40002.bin 0x8000000 -V "after_programming"
start /b /wait ST-LINK_CLI.exe -c SWD -P RtdEmulator-App-20200531-2.bin 0x8001000 -V "after_programming"
